...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('frontend_assets') }}/images/favicon.png">
    <link rel="stylesheet" href="{{ asset('frontend_assets') }}/vendor/chartist/css/chartist.min.css">
    <link href="{{ asset('frontend_assets') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css"
        rel="stylesheet">
    <link href="{{ asset('frontend_assets') }}/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
...
<body>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button"
                                    ...
                                    <div class="header-info">
                                        <span class=" ProName"><strong>Peter Parkur</strong></span>
                                        <p class="fs-12 mb-0 ProName">Super Admin</p>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('frontend.profile.index') }}" class="dropdown-item ai-icon">
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('frontend_assets') }}/vendor/global/global.min.js"></script>
    <script src="{{ asset('frontend_assets') }}/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
    <script src="{{ asset('frontend_assets') }}/vendor/chart.js/Chart.bundle.min.js"></script>
    <script src="{{ asset('frontend_assets') }}/js/custom.min.js"></script>
    <script src="{{ asset('frontend_assets') }}/js/deznav-init.js"></script>
    <script src="{{ asset('frontend_assets') }}/vendor/owl-carousel/owl.carousel.js"></script>

    <!-- Chart piety plugin files -->
    <script src="{{ asset('frontend_assets') }}/vendor/peity/jquery.peity.min.js"></script>

    <!-- Apex Chart -->
    <script src="{{ asset('frontend_assets') }}/vendor/apexchart/apexchart.js"></script>

    <!-- Dashboard 1 -->
    <script src="{{ asset('frontend_assets') }}/js/dashboard/dashboard-1.js"></script>
    <script>
